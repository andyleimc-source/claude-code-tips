...
1. 当前模型名称（如 [Sonnet]）
2. 当前会话上下文窗口用量（CTX xx% of 200k）
3. 5小时滚动用量及重置时间（5h: xx% used, resets HH:MM）
4. 本周用量及下次刷新时间（7d: xx% used, resets MM/DD HH:MM）

格式参考：[Sonnet] CTX 34% of 200k | 5h: 61% used (resets 14:30) | 7d: 18% used (resets 04/07 09:00)
```
